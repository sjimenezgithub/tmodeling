...
(define (problem p005-multiban-temporal)
  (:domain sokoban)
  (:objects
    dir-down - direction
    dir-left - direction
  ...
  (:init
    ...
    (MOVE-DIR pos-5-8 pos-5-9 dir-down)
    (MOVE-DIR pos-5-8 pos-6-8 dir-right)
    (MOVE-DIR pos-5-9 pos-5-8 dir-up)
    (MOVE-DIR pos-5-9 pos-6-9 dir-right)
    ...
    (MOVE-DIR pos-6-8 pos-6-9 dir-down)
    (MOVE-DIR pos-6-9 pos-5-9 dir-left)
    (MOVE-DIR pos-6-9 pos-6-8 dir-up)
    (at player-01 pos-2-2)
    (at player-02 pos-5-5)
    (at stone-01 pos-3-3)
    (at stone-02 pos-4-4)
    (at stone-03 pos-3-5)
    (at stone-04 pos-4-5)
