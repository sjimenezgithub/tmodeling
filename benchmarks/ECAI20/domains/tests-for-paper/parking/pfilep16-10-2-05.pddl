(define   (problem parking)
  ...
  (:goal
    (and
      ...
      (at-curb-num car_1 curb_07)
      (at-curb-num car_2 curb_03)
      (at-curb-num car_3 curb_04)
      (at-curb-num car_4 curb_06)
      (at-curb-num car_5 curb_01)
      (at-curb-num car_6 curb_10)
      (at-curb-num car_7 curb_13)
      (at-curb-num car_8 curb_14)
      (at-curb-num car_9 curb_11)
    )
  )
